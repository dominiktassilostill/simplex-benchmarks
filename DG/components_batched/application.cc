    ...
    for (unsigned int face = range.first; face < range.second; ++face)
      {
        ...
        const std::array<unsigned int, n_lanes> cell_ids_interior = face_info.cells_interior;
        const std::array<unsigned int, n_lanes> cell_ids_exterior = face_info.cells_exterior;
